...
class TutorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tutor" do
    assert_difference("Tutor.count") do
      post tutors_url, params: { tutor: { email: @tutor.email, endereco: @tutor.endereco, nome: @tutor.nome, telefone: @tutor.telefone } }
    end
  ...
  test "should update tutor" do
    patch tutor_url(@tutor), params: { tutor: { email: @tutor.email, endereco: @tutor.endereco, nome: @tutor.nome, telefone: @tutor.telefone } }

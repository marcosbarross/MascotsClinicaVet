...
class FuncionariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create funcionario" do
    assert_difference("Funcionario.count") do
      post funcionarios_url, params: { funcionario: { cargo: @funcionario.cargo, contato: @funcionario.contato, login: @funcionario.login, nome: @funcionario.nome, senha: @funcionario.senha } }
    end
  ...
  test "should update funcionario" do
    patch funcionario_url(@funcionario), params: { funcionario: { cargo: @funcionario.cargo, contato: @funcionario.contato, login: @funcionario.login, nome: @funcionario.nome, senha: @funcionario.senha } }
